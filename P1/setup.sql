...
CREATE TABLE Order (oid BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, cid BIGINT UNSIGNED NOT NULL, orderDate DATE NOT NULL DEFAULT NOW(), delivered DATE NULL, PRIMARY KEY(oid), FOREIGN KEY(cid))
