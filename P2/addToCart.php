...
if (!isset($_SESSION["name"])){
    ...
    $query = $pdo->prepare("INSERT INTO Orders VALUES(NULL, :cid, :pid, :oDate, NULL )");
    $key = array(":cid" => $_SESSION['cid'], ":pid" => $_GET['pid'], ":oDate" => date());
    try {
        $query->execute($key);
        echo "<h1> Item succesfully added to cart!</h1>";
        echo "<h2><a href='index.php?request=catalog.php'>Continue shopping?</a></h2>";
    }
    catch(exception $e){
